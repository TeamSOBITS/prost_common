...
# Export variables
echo 'export TURTLEBOT_GAZEBO_WORLD_FILE="$HOME/catkin_ws/src/prost_common/turtlebot2/turtlebot2_on_noetic/turtlebot_simulator/turtlebot_gazebo/worlds/playground.world"' >> ~/.bashrc
echo 'export TURTLEBOT_STAGE_MAP_FILE="$HOME/catkin_ws/src/prost_common/turtlebot2/turtlebot2_on_noetic/turtlebot_simulator/turtlebot_stage/maps/maze.yaml"' >> ~/.bashrc
echo 'export TURTLEBOT_STAGE_WORLD_FILE="$HOME/catkin_ws/src/prost_common/turtlebot2/turtlebot2_on_noetic/turtlebot_simulator/turtlebot_stage/maps/stage/maze.world"' >> ~/.bashrc
